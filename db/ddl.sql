CREATE TABLE `qiwi_payment_methods` (
  ...
  PRIMARY KEY (`id`),
  KEY `index_qiwi_payment_methods_on_kb_account_id` (`kb_account_id`),
  KEY `index_qiwi_payment_methods_on_kb_payment_method_id` (`kb_payment_method_id`)
) ENGINE=InnoDB CHARACTER SET utf8 COLLATE utf8_bin;

CREATE TABLE `qiwi_transactions` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `qiwi_response_id` int(11) NOT NULL,
  ...
  `updated_at` datetime NOT NULL,
  PRIMARY KEY (`id`),
  KEY `index_qiwi_transactions_on_kb_payment_id` (`kb_payment_id`)
) ENGINE=InnoDB CHARACTER SET utf8 COLLATE utf8_bin;
