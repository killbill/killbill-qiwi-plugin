CREATE TABLE qiwi_payment_methods (
  id serial UNIQUE,
...
CREATE INDEX index_qiwi_payment_methods_kb_account_id ON qiwi_payment_methods(kb_account_id);
CREATE INDEX index_qiwi_payment_methods_kb_payment_method_id ON qiwi_payment_methods(kb_payment_method_id);

CREATE TABLE qiwi_transactions (
  id serial UNIQUE,
  qiwi_response_id bigint /*! unsigned */ NOT NULL,
...
CREATE INDEX index_qiwi_transactions_kb_payment_id ON qiwi_transactions(kb_payment_id);
CREATE INDEX index_qiwi_transactions_qiwi_response_id ON qiwi_transactions(qiwi_response_id);

CREATE TABLE qiwi_responses (
  id serial UNIQUE,
  api_call varchar(255) NOT NULL,
...
CREATE INDEX index_qiwi_responses_kb_payment_id_kb_tenant_id ON qiwi_responses(kb_payment_id, kb_tenant_id);
