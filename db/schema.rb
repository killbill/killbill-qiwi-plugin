...
ActiveRecord::Schema.define(:version => 20140410153635) do
  ...
  add_index(:qiwi_payment_methods, :kb_account_id)
  add_index(:qiwi_payment_methods, :kb_payment_method_id)

  create_table "qiwi_transactions", :force => true do |t|
    t.integer  "qiwi_response_id",  :null => false
    t.string   "api_call",                       :null => false
    t.string   "kb_payment_id",                  :null => false
    t.string   "kb_payment_transaction_id",      :null => false
    t.string   "transaction_type",               :null => false
    t.string   "payment_processor_account_id"
    t.string   "txn_id"                          # qiwi transaction id
    # Both null for void
  ...
  add_index(:qiwi_transactions, :kb_payment_id)
  add_index(:qiwi_transactions, :qiwi_response_id)

  create_table "qiwi_responses", :force => true do |t|
    t.string   "api_call",          :null => false
  ...
  add_index(:qiwi_responses, [:kb_payment_id, :kb_tenant_id])
end
